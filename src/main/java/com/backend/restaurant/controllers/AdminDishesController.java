...
public class AdminDishesController implements Initializable {
    ...
    void startCreateDish(ActionEvent event) throws IOException {
        ...
        AnchorPane dish_create_panel = FXMLLoader.load(getClass().getResource("/com/backend/restaurant/dish_create.fxml"));
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    if (ind != -1) {
                                        ...
                                        if (buttonName.contentEquals("edit")) {
                                            ...
                                            try {
                                                VBox dish_create_panel = FXMLLoader.load(getClass().getResource("/com/backend/restaurant/admin_dishes.fxml"));
                                                Main.getBorderPane().setCenter(dish_create_panel);
                                            } catch (IOException e1) {
                                                e1.printStackTrace();
                                            }
