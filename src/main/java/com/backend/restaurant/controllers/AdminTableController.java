...
public class AdminTableController implements Initializable {
    ...
    void createTable(ActionEvent event) throws IOException {
        ...
        AnchorPane admin_table_create_panel = FXMLLoader.load(getClass().getResource("/com/backend/restaurant/table_create.fxml"));
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    if (ind != -1) {
                                        ...
                                        if (buttonName.contentEquals("edit")) {
                                            ...
                                            try {
                                                VBox admin_table_table_panel = FXMLLoader.load(getClass().getResource("/com/backend/restaurant/admin_table.fxml"));
