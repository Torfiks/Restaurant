...
public class TodaySaleConroller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        LocalDateTime startOfDay = LocalDateTime.parse(localDateTime.with(LocalTime.MIN).toString());
        LocalDateTime endOfDay = LocalDateTime.parse(localDateTime.with(LocalTime.MAX).toString());
